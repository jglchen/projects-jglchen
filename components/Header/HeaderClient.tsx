...
const Header = ({headerData, headTitle, locale}: Props) => {
        ...
        <div className="w-full lg:w-2/5 flex items-center justify-between">
          <a href={`/${locale}`}>
            <div className="w-full flex items-center justify-start">            
              ...
              <div className="ml-2 text-3xl font-bold leading-tight text-black dark:text-white ">
                {headTitle}
              </div>
                  ...
                  {menuItem.submenu ? (
                    ...
                    <Link
                      ...
                      className={
                          ...
                          */
                          (menuItem.path === '/' && pathName === menuItem.path) || (menuItem.path !== '/' && pathName.includes(menuItem.path as string))
