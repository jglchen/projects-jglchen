...
2. Rather than pushing data, we can fetch real-time data on demand. For example, the Vercel dashboard delivers real-time updates using [SWR](https://swr.vercel.app/).
