---
title: 'Laravel Chirper API Token Auth Backend with Next.js Frontend'
...
This project tries **use Laravel Chirper API as the backend and set up web display and authentication with Next.js as the browser frontend**.
