...
同時也提供 **iOS** 和 **Android** 行動應用程式。 這些應用程式是使用 **React Native** 開發的，任何有興趣的人都可以使用[iOS Simulator Build](https://expo.dev/accounts/jglchen/projects/firestore-realtime-chat/builds/2c3cb3b7-2253-421f-9ab7-cb5ff98492b6) 和 [Android Internal Distribution Build](https://expo.dev/accounts/jglchen/projects/firestore-realtime-chat/builds/de478887-4f60-43d5-9911-d20d55627706)來測試開發版本。如果發現連結檔案儲存已過期，請前往[https://projects-jglchen.vercel.app/zh-tw/contact](https://projects-jglchen.vercel.app/zh-tw/contact)索取建置檔案。
